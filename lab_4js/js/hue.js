...
XLsVj69SEp37wgnzB10z-y4g1DwjEQrspxH5geMl
...
const user = "XLsVj69SEp37wgnzB10z-y4g1DwjEQrspxH5geMl";
...
// Assuming the rest of your script is unchanged, add this below your existing JavaScript code

// Retrieve the button element
const toggleLightButton = document.getElementById("toggleLight");

// Initialize a variable to keep track of the light state
let isLightOn = false; 
